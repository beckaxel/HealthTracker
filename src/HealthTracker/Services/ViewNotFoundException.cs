...
namespace HealthTracker.Services
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewNotFoundException"/> class
        /// </summary>
        ...
        public ViewNotFoundException(string message, System.Exception inner) : base(message, inner)
        {
        }
